...
export const CATEGORY_SEO_DATA: Record<string, CategorySEOData> = {
  "casa-transportes": {
    ...
    diferenciais: [
      "100% gratuito — sem assinaturas e sem cadastro",
